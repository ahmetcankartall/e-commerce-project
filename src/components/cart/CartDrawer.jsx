    ...
    <>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 flex flex-col gap-12 border-[#111111]">
          {/* Örnek item */}
          <div className="flex items-center gap-4 border-b pb-4  border-[#111111]">
            <div className="w-24 h-40 bg-gray-200 rounded-md" />
            <div className="flex flex-col  gap-3 ">
              <span className="text-sm font-montserrat font-bold">Ürün Adı: (ürün adı)</span>
              ...
              <div className="  flex flex-row  bg-[#f5f5f5] border border-[#efefef]  p-1  self-start rounded-lg" >
                <button className="px-2 py-1 text-sm  hover:cursor-pointer font-montserrat text-sm">-</button>
                <span className="px-4 py-1 text-sm font-montserrat text-sm font-bold">1</span>
                <button className="px-2 py-1 text-sm  hover:cursor-pointer rounded-lg font-montserrat text-sm">+</button>
              </div>
            </div>
          </div>
        ...
        {/* Footer */}
        <div className="border-t px-4 py-4 flex flex-col gap-3 px-16">
