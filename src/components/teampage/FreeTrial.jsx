...
export default function FreeTrial() {
  return (
    <section className="relative overflow-hidden w-full lg:min-h-[282px] min-h-[352px] lg:max-w-[607px] max-w-[302px] flex justify-center items-center flex-col  border gap-9 mx-auto py-10">
...
do met sent. RELIT official consequent.</p>
        ...
        <div className="border flex flex-row gap-6">
            <button className="border"><Instagram className="w-6 h-6 text-[#3eb2f2]" /></button>
            <button className="border"><Facebook className="w-6 h-6 text-[#3eb2f2]" /></button>
            <button className="border"><Twitter className="w-6 h-6 text-[#3eb2f2]" /></button>
            <button className="border"><Linkedin className="w-6 h-6 text-[#3eb2f2]" /></button>
        </div>
    </section>
  );
}
