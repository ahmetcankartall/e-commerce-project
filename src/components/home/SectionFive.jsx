         ...
         {/* sağ taraf */}
            <div className=" w-full  lg:max-w-[658px] lg:min-h-[799px] max-w-[376px] min-h-[2273px] flex flex-col gap-[10px]">
             <div className=" flex lg:flex-row flex-col justify-between items-center lg:py-0 py-8 lg:gap-[1px] gap-[25px]">
                <h5 className=" font-montserrat font-bold text-[16px] leading-[24px] tracking-[0.1px] text-[#252B42] flex items-center">BESTSELLER PRODUCTS</h5>
    ...
    <ChevronRight />
              ...
              <div className=" w-full  lg:max-w-[657px] lg:min-h-[727px] max-w-[376px] min-h-[1891px] p-3 flex lg:flex-row flex-wrap flex-col gap-[30px] items-center justify-center">
                ...
                {genderBestSellerList.map((product)=>(
                   <div className=" lg:max-w-[183px] lg:h-[324px] max-w-[328px] h-[589px] ">
                  <img
            ...
            <div className=" flex flex-col items-center justify-between h-[162px] py-6">
              <h5 className=" font-montserrat font-bold text-[16px] leading-[24px] tracking-[0.1px] text-center line-clamp-1">{product.name}</h5>
            <p className="font-montserrat font-bold text-[14px] leading-[24px] tracking-[0.2px] text-center text-[#737373] line-clamp-2">{product.description}</p>
            <div className=" w-full flex flex-row items-center justify-center gap-3">
              <h5 className=" font-montserrat font-bold text-[16px] leading-[24px] tracking-[0.1px] text-center text-[#BDBDBD]">{product.price}$</h5>
              <h5 className=" font-montserrat font-bold text-[16px] leading-[24px] tracking-[0.1px] text-center text-[#23856D]"> {product.price}$</h5>
            </div>
            </div>
