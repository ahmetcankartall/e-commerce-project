...
export default function ContactVisit() {
  return (
    <div className="w-full flex flex-col items-center justify-center gap-6 py-12 lg:gap-[80px] gap-[60px]">
...
with big ideas</h2>
    ...
    <div className=" w-full max-w-[328px] min-h-[393px] lg:min-h-[403px] gap-[15px] flex flex-col items-center justify-center">
        <div className=" w-full max-w-[328px] min-h-[393px] lg:min-h-[403px] gap-[15px]  flex flex-col items-center justify-center "> <Phone size={55} className='text-[#23A6F0] '/>
     ...
     <button className="border border-[#23A6F0] rounded-full w-[189px] h-[54px] text-[#23A6F0]">Submit Request</button></div>
    </div>


     <div className=" w-full max-w-[328px] min-h-[393px] lg:min-h-[403px] gap-[15px] bg-[#252B42] flex flex-col items-center justify-center "> <MapPin size={55} stroke="#252B42"  fill="#23a6f0"/>
     ...
     <button className="border border-[#23A6F0] bg-[#252B42] rounded-full w-[189px] h-[54px] text-[#23A6F0]">Submit Request</button></div>



      <div className=" w-full max-w-[328px] min-h-[393px] lg:min-h-[403px]">
        <div className=" w-full max-w-[328px] min-h-[393px] lg:min-h-[403px] gap-[15px]  flex flex-col items-center justify-center "> <Mail size={55} className='text-[#23A6F0]'/>
     <h6 className="font-montserrat font-bold text-[14px] leading-[24px] tracking-[0.2px] text-center">georgia.young@example.com</h6>
     <h6 className="font-montserrat font-bold text-[14px] leading-[24px] tracking-[0.2px] text-center ">georgia.young@ple.com</h6>
     <h5 className="font-montserrat font-bold text-[16px] leading-[24px] tracking-[0.1px] text-center ">Get Support</h5>
     <button className="border border-[#23A6F0]  rounded-full w-[189px] h-[54px] text-[#23A6F0]">Submit Request</button></div>
