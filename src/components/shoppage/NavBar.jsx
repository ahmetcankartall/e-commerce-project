...
<div className="lg:w-[363px] h-[48px] flex justify-center items-center lg:gap-[10px]">
    <div className=" lg:w-[125px] lg:h-[36px] flex items-center justify-center gap-[10px]">
         ...
         <h6 className=" font-normal text-[12px] leading-[16px] tracking-[0.2px] text-white">(225) 555-0118</h6>    
    </div>
    <div className=" lg:w-[228px] lg:h-[36px] flex items-center justify-center gap-[10px]">
         <Mail className="text-white w-[16px] h-[16px]"/>
         <h6 className="font-normal text-[12px] leading-[16px] tracking-[0.2px] text-white">michelle.rivera@example.com</h6>
    </div>
</div>
<div className=" w-[343px] h-[44px] flex items-center justify-center">
    <h6 className=" font-bold text-sm leading-6 tracking-[0.2px] text-white">Follow Us  and get a chance to win 80% off</h6>
</div>
<div className=" w-[235px] h-[46px] flex items-center justify-center gap-[10px]">
    <h6 className=" font-bold text-[14px] leading-[24px] tracking-[0.2px] text-white">Follow Us  :</h6>
