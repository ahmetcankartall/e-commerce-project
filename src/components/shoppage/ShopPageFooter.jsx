...
export default function ShopPageFooter() {
  return (
    <footer className="w-full bg-white text-black  flex flex-col items-center justify-center">
      <div className="w-full lg:max-w-[1050px] flex flex-col md:flex-row md:justify-between items-center gap-2 py-10 ">
    ...
    <button className="bg-[#23a6f0] text-white px-6 font-montserrat font-bold text-[14px] tracking-[0.2px] hover:bg-blue-600 transition rounded-sm">
      Subscribe
        ...
        <div className=" w-full lg:max-w-[1050px] max-w-[414px] flex lg:flex-row flex-col lg:justify-between lg:gap-0  items-center ">
          <h6 className="flex items-center justify-center font-montserrat font-bold text-[14px] leading-[24px] tracking-[0.2px] text-[#737373]">Made With Love By Finland All Right Reserved </h6>
